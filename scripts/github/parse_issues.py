#!/usr/bin/env python3
"""
Parse GitHub Issue JSON and format.

Usage:
    python scripts/github/parse_issues.py temp/issues/issue_181_raw.json
"""
...
def main():
    if len(sys.argv) != 2:
        print("Usage: python scripts/github/parse_issues.py <JSON_FILE>")
        sys.exit(1)
