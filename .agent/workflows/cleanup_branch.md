...
1. **Local Cleanup**
   ...
   - Clean up temporary files (preserve folder structure): `Get-ChildItem temp -Recurse -File | Where-Object {$_.Name -notin @(".gitkeep", "analytics_gap_analysis.md", "lean_architecture_vision.md", "signal_lifecycle_architecture.md")} | Remove-Item -Force`
